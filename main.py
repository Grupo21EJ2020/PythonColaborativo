...
from Andres-Delgado0 import AndresDelgado0
...
if opcion == 1:
    ...
    print ("Eligio los pasatiempos del usuario 10")  
elif opcion ==11:
    print ("Eligio los pasatiempos del usuario 11")
elif opcion ==12:
    ...
    objetoPasatiempo = AndresDelgado0()
    objetoPasatiempo.imprimirPasatiempos()
elif opcion ==21:
